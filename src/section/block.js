 ...
 */
registerBlockType( 'cgb/gostudy-section', {
			...
			<div className={classes}>
				...
				<div className="section__content" >
					<div className="section__content__inner" >
						{ attributes.title && attributes.title.length > 0 && <h2 className="section__title" style={ { color : attributes.titleColor} }>{ attributes.title }</h2> }
